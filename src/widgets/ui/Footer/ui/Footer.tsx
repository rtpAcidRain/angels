                    ...
                    <div className="pb-[1.375rem] sm:pb-[1.9375rem] ">
                        <div className="flex flex-col gap-[1.625rem] sm:grid lg:grid-cols-12 sm:gap-5">
                            ...
                            <div className="col-span-3">
                                <h6 className="text-13med text-bluegrey400 mb-3 sm:mb-[1.125rem]">Курсы</h6>
                                <ul className="text-17med flex flex-col gap-[6px] sm:gap-2">
                                    <li>
                                        <Link to="/directions/architectual">Архитектурный светодизайнер</Link>
                                    </li>
                                    <li>
                        ...
                        <div className="mt-4 sm:mt-[6.0625rem] sm:grid sm:grid-cols-12 sm:gap-5">
                            ...
                            <div className="col-start-1 row-start-1 col-span-4 sm:grid ">
                                ...
                                <Link
                                    ...
                                    className="text-15reg sm:text-17med pb-[1px] border-b border-dashed border-bluegrey400 nt-4 sm:mt-1 block w-fit transition-colors hover:text-blue600 hover:border-blue600"
                                >
                                    Показать на картах
                                </Link>
                            </div>
