...
const learningList = [
    {
        themes: [
            'Тема 1: «Введение в профессию Светодизайнер. Основные функции и этапы работ»',
            'Тема 2: «Применение светового архитектурного для коммерческих объектов и др.»',
            'Тема 3: «Применение светового архитектурного для жилых объектов и др.»',
        ],
    },
];
