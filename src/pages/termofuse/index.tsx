        ...
        <div className="pt-50 sm:pt-0 sm:grid grid-cols-12 gap-[1.125rem] privacy-policy ">
            ...
            <section className="col-span-6">
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        Настоящее Пользовательское соглашение (далее – Соглашение) относится
                        к сайту Интернет-ресурса «Свет Эксперт», расположенному по адресу
                        <a href="https://www.svet-expert.com">www.svet-expert.com</a>
                        , и ко
                ...
                <p>
                    <span>1.2. </span>
                    <span>
                        Сайт Интернет-ресурса «Свет Эксперт» (далее – Сайт) является
                        собственностью общества с ограниченной ответственностью «Свет
                        Эксперт».
                    </span>
                </p>
                <p>
                    ...
                    <span>
                        ...
                        Интернет-ресурса «Свет Эксперт» (далее – Администрация сайта) и
                ...
                <p>
                    <span>1.5. </span>
                    <span>
                        Продолжение использования Сайта Пользователем означает принятие
                ...
                <p>
                    <span>2.1. </span>
                    <span>
                        «Свет Эксперт» – Интернет-ресурс, расположенный на доменном имени
                        {' '}
                        <a href="https://www.svet-expert.com">www.svet-expert.com</a>
                        ,
                ...
                <p>
                    <span>2.2. </span>
                    <span>
                        Интернет-ресурс – сайт, содержащий информацию о Услугах, Продавце,
                        позволяющий ознакомится с вариантами предоставляемых услуг.
                    </span>
                </p>
                <p>
                    <span>2.3. </span>
                    <span>
                        Администрация сайта Интернет-ресурса – уполномоченные сотрудники на
                        управления Сайтом, действующие от имени ООО «Свет Эксперт».
                    </span>
                </p>
                <p>
                    <span>2.4. </span>
                    <span>
                        Пользователь сайта Интернет-ресурса (далее ‑ Пользователь) – лицо,
                ...
                <p>
                    <span>2.5. </span>
                    <span>
                        Содержание сайта Интернет-ресурса (далее – Содержание) - охраняемые
                ...
                <h4>3. Предмент соглашения</h4>
                <p>
                    <span>3.1. </span>
                    {' '}
                    <span>
                        Предметом настоящего Соглашения является предоставление Пользователю
                        Интернет-ресурса доступа к содержащимся на сайте услугам.
                    </span>
                </p>
                <p>
                    <span>3.2. </span>
                    {' '}
                    <span>
                        Интернет-ресурс предоставляет Пользователю следующие виды услуг
                        (сервисов):
                    </span>
                </p>
                <p>
                    • доступ к электронному контенту на бесплатной основе, просмотра
                    контента;
                </p>
                <p>• доступ к средствам навигации Интернет-ресурса;</p>
                <p>
                ...
                <p>
                    ...
                    (сервисы) Интернет-ресурса, а также любые их последующие модификации и
                ...
                <p>
                    <span>3.4. </span>
                    {' '}
                    Доступ к Интернет-ресурсу предоставляется на
                    бесплатной основе.
                </p>
                <p>
                    <span>3.5. </span>
                    ...
                    Получая доступ к Сайту Пользователь считается присоединившимся к
                ...
                <p>
                    <span>4.1. </span>
                    <span>
                        Изменять правила пользования Сайтом, а также изменять содержание
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        Изменять размер оплаты, взимаемый за предоставление доступа к
                ...
                <p>
                    ...
                    <span>
                        {' '}
                        Собирать, анализировать, использовать, делиться (в том числе на
                        платной основе) информацией о Пользователе, содержащейся на Сайте,
                        включая, но не ограничиваясь, информацией о контактных и личных
                        данных Пользователя, информацией о действиях Пользователя на Сайте
                        и.т.д.
                    </span>
                </p>
                ...
                <p>
                    <span>4.2.1.</span>
                    {' '}
                    <span>Получить доступ к использованию Сайта.</span>
                </p>
                <p>
                    <span>4.2.2.</span>
                    {' '}
                    <span>
                        Пользоваться всеми имеющимися на Сайте услугами, а также приобретать
                ...
                <p>
                    <span> 4.2.3. </span>
                    <span>
                        Задавать любые вопросы, относящиеся к услугам Интернет-ресурса по
                ...
                <p> Пользователь Сайта обязуется:</p>
                <p>
                    <span>4.3.1.</span>
                    <span>
                        {' '}
                        Предоставлять по запросу Администрации сайта дополнительную
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        Не использовать сервисы сайта Интернет-ресурса с целью:
                        <span />
                    </span>
                </p>
                <p>
                    <span>4.3.7.1. </span>
                    <span>
                        загрузки контента, который является незаконным, нарушает любые права
                        третьих лиц; пропагандирует насилие, жестокость, ненависть и (или)
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        побуждения к совершению противоправных действий, а также содействия
                        лицам, действия которых направлены на нарушение ограничений и
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        нарушения прав несовершеннолетних лиц и (или) причинение им вреда в
                        любой форме.
                    </span>
                </p>
                <p>
                    <span>4.3.7.4.</span>
                    {' '}
                    <span>ущемления прав меньшинств.</span>
                </p>
                <p>
                    <span>4.3.7.5.</span>
                    {' '}
                    <span>
                        представления себя за другого человека или представителя организации
                ...
                <p>
                    ...
                    <span>
                        ...
                        какого-либо Товара из каталога Интернет-ресурса, размещенного на
                        Сайте.
                    </span>
                </p>
                <p>
                ...
                <p>
                    ...
                    <span>
                        ...
                        Сайта данного Интернет-ресурса;
                    </span>
                </p>
                <p>
                    <span>4.4.2.</span>
                    {' '}
                    <span>Нарушать надлежащее функционирование Сайта;</span>
                </p>
                <p>
                    <span>4.4.3.</span>
                    <span>
                        {' '}
                        Любым способом обходить навигационную структуру Сайта для получения
                        или попытки получения любой информации, документов или материалов
                        любыми средствами, которые специально не представлены сервисами
                        данного Сайта;
                    </span>
                </p>
                <p>
                    ...
                    {' '}
                    <span>
                        Нарушать систему безопасности или аутентификации на Сайте или в
                ...
                <h4>5. Использование сайта интернет-ресурса</h4>
                ...
                <p>
                    ...
                    <span>
                        {' '}
                        Содержание Сайта защищено авторским правом, законодательством о
                ...
                <p>
                    ...
                    <span>
                        {' '}
                        При использовании некоторых сервисов сайта, может потребоваться
                ...
                <p>
                    <span>5.6. </span>
                    <span>
                        Пользователь должен незамедлительно уведомить Администрацию сайта о
                ...
                <p>
                    ...
                    <span>
                        ...
                        дополнительные положения и условия о покупке Товара и оказании
                ...
                <p>
                    ...
                    <span>
                        {' '}
                        Информация, размещаемая на Сайте не должна истолковываться как
                ...
                <p>
                    ...
                    <span>
                        ...
                        их реализации и (или) оказываемым услугам Интернет-ресурсом.
                    </span>
                </p>
                <p>
                    <span>
                        {' '}
                        Документы, указанные в пунктах 5.10.1 - 5.10.4 настоящего Соглашения
                        регулируют в соответствующей части и распространяют свое действие на
                        использование Пользователем Сайта. В настоящее Соглашение включены
                        следующие документы:
                    </span>
                </p>
                <p>
                ...
                <p>
                    <span>5.10.2.</span>
                    {' '}
                    <span>Договор купли-продажи товаров дистанционным способом;</span>
                </p>
                <p>
                    <span>5.10.3.</span>
                    {' '}
                    <span>Заявка на оформление заказа;</span>
                </p>
                <p>
                    <span>5.10.4.</span>
                    {' '}
                    <span>Предложения и замечания.</span>
                </p>
                <p>
                    <span>5.11.</span>
                    {' '}
                    <span>
                        Любой из документов, перечисленных в пункте 5.10. настоящего
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        Действия систем переводов, банков, платежных систем и за задержки
                ...
                <p>
                    <span>6.2.4.</span>
                    <span>Содержание (контент) информации размещенной на Сайте.</span>
                </p>
                <p>
                    <span>6.3.</span>
                    <span>
                        {' '}
                        Пользователь самостоятельно несет ответственность за интерпретацию и
                        использование контента (информации), размещенного на Сайте.
                    </span>
                </p>
                <h4>7. Нарушение условий пользовательского соглашения</h4>
                <p>
                    <span>7.1.</span>
                    <span>
                        {' '}
                        ...
                        права других Пользователей Сайта.
                    </span>
                </p>
                <p>
                    <span>7.2.</span>
                    <span>
                        ...
                        безопасности название организации, Пользователей.
                    </span>
                </p>
                <p>
                    <span>7.3.</span>
                ...
                <p>
                    ...
                    <span>
                        ...
                        настоящего Соглашения обязательным условием до обращения в суд
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        Получатель претензии в течение 10 (десяти) календарных дней со дня
                        ее получения, письменно уведомляет заявителя претензии о результатах
                ...
                <p>
                    ...
                    <span>
                        {' '}
                        При невозможности разрешить спор в добровольном порядке любая из
                ...
                <p>
                    ...
                    <span>
                        {' '}
                        Любой иск в отношении условий использования Сайта должен быть
                        предъявлен в течение срока после возникновения оснований для иска,
                        ...
                        пункта любой иск или основания для иска погашаются исковой
                        давностью.
                    </span>
                </p>
                ...
                <p>
                    ...
                    {' '}
                    <span>
                        Отзывы Пользователя, размещенные на Сайте, не являются
