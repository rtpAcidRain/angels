...
const list = [
    {
        ...
        text: `
             Слушатель сам выбирает себе дни и время прохождения курса, за исключением консультаций в виде вебинаров. Они проходят по расписанию. Запись вебинара отражается в личном кабинете.\n
Время.Пример: курс повышения квалификации 72 ак.ч., срок обучения 2 месяца - это значит, что слушателю необходимо выделить 4,5 часа в неделю
        `,
    }, {
        ...
        text: `
             Для дополнительного образования: паспорт, контактные данные, паспорт, СНИЛС, заявку на обучение\n
